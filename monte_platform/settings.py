"""
Django settings for monte_platform project.
"""
...
SECRET_KEY = os.environ.get('SESSION_SECRET', 'monte-academic-platform-secret-key-django')
...
ROOT_URLCONF = 'monte_platform.urls'
...
WSGI_APPLICATION = 'monte_platform.wsgi.application'
